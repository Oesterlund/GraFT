...
def node_condense_faster(imageFiltered, imageSkeleton, kernel):
    """
    modified version of node_condense.node_condense_original with the following differences:
...
def node_condense_faster_modularized(imageFiltered, imageSkeleton, kernel):
    """
    (This is a modularized version of node_condense_faster, which in turn
    is a speed-optimized version of node_condense_original.)
