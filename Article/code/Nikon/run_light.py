...
# -*- coding: utf-8 -*-
"""
Created on Mon Aug  7 12:56:03 2023
...
img = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/light/0-10min/cell1/cell1.tif')
maskDraw = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/light/0-10min/cell1/mask.tif')
plt.figure()
plt.imshow(img[0]*maskDraw,cmap='gray_r')
img_o = img*maskDraw
create_all(pathsave= "/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/code/output/light/latB_0-10min/cell1/",
                        img_o=img_o,
                        maskDraw=maskDraw,
                        size=8,eps=100,thresh_top=0.1,sigma=sigma,small=small,angleA=140,overlap=4,max_cost=200,
                        name_cell='cell 1')


img = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/light/0-10min/cell2/cell2.tif')
maskDraw = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/light/0-10min/cell2/mask.tif')
plt.figure()
plt.imshow(img[0]*maskDraw,cmap='gray_r')
img_o = img*maskDraw
create_all(pathsave= "/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/code/output/light/latB_0-10min/cell2/",
                        img_o=img_o,
                        maskDraw=maskDraw,
                        size=6,eps=100,thresh_top=0.1,sigma=sigma,small=small,angleA=140,overlap=4,max_cost=200,
                        name_cell='cell 2')


img = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/light/0-10min/cell3/cell3.tif')
maskDraw = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/light/0-10min/cell3/mask.tif')
plt.figure()
plt.imshow(img[0]*maskDraw,cmap='gray_r')
img_o = img*maskDraw
create_all(pathsave= "/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/code/output/light/latB_0-10min/cell3/",
                        img_o=img_o,
                        maskDraw=maskDraw,
                        size=6,eps=100,thresh_top=0.1,sigma=sigma,small=small,angleA=140,overlap=4,max_cost=200,
                        name_cell='cell 3')

img = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/light/0-10min/cell4/cell4.tif')
maskDraw = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/light/0-10min/cell4/mask.tif')
plt.figure()
plt.imshow(img[0]*maskDraw,cmap='gray_r')
img_o = img*maskDraw
create_all(pathsave= "/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/code/output/light/latB_0-10min/cell4/",
                        img_o=img_o,
                        maskDraw=maskDraw,
                        size=6,eps=100,thresh_top=0.1,sigma=sigma,small=small,angleA=140,overlap=4,max_cost=200,
                        name_cell='cell 4')
...
img = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/light/10-20min/cell1/cell1.tif')
maskDraw = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/light/10-20min/cell1/mask.tif')
plt.figure()
plt.imshow(img[0]*maskDraw,cmap='gray_r')
img_o = img*maskDraw
create_all(pathsave= "/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/code/output/light/latB_10-20min/cell1/",
                        img_o=img_o,
                        maskDraw=maskDraw,
                        size=8,eps=100,thresh_top=0.01,sigma=sigma,small=small,angleA=140,overlap=4,max_cost=200,
                        name_cell='cell 1')


img = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/light/10-20min/cell2/cell2.tif')
maskDraw = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/light/10-20min/cell2/mask.tif')
plt.figure()
plt.imshow(img[0]*maskDraw,cmap='gray_r')
img_o = img*maskDraw
create_all(pathsave= "/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/code/output/light/latB_10-20min/cell2/",
                        img_o=img_o,
                        maskDraw=maskDraw,
                        size=6,eps=100,thresh_top=0.01,sigma=sigma,small=small,angleA=140,overlap=4,max_cost=200,
                        name_cell='cell 2')


img = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/light/10-20min/cell3/cell3.tif')
maskDraw = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/light/10-20min/cell3/mask.tif')
plt.figure()
plt.imshow(img[0]*maskDraw,cmap='gray_r')
img_o = img*maskDraw
create_all(pathsave= "/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/code/output/light/latB_10-20min/cell3/",
                        img_o=img_o,
                        maskDraw=maskDraw,
                        size=6,eps=100,thresh_top=0.01,sigma=sigma,small=small,angleA=140,overlap=4,max_cost=200,
                        name_cell='cell 3')

img = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/light/10-20min/cell4/cell4.tif')
maskDraw = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/light/10-20min/cell4/mask2.tif')
maskDraw = np.asarray(maskDraw,dtype=bool)
plt.figure()
plt.imshow(img[0]*maskDraw,cmap='gray_r')
img_o = img*maskDraw
create_all(pathsave= "/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/code/output/light/latB_10-20min/cell4/",
                        img_o=img_o,
                        maskDraw=maskDraw,
                        size=6,eps=100,thresh_top=0.01,sigma=sigma,small=small,angleA=140,overlap=4,max_cost=200,
                        name_cell='cell 4')
...
img = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/light/20-30min/cell1/cell1.tif')
maskDraw = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/light/20-30min/cell1/mask.tif')
plt.figure()
plt.imshow(img[0]*maskDraw,cmap='gray_r')
img_o = img*maskDraw
create_all(pathsave= "/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/code/output/light/latB_20-30min/cell1/",
                        img_o=img_o,
                        maskDraw=maskDraw,
                        size=8,eps=100,thresh_top=0.01,sigma=sigma,small=small,angleA=140,overlap=4,max_cost=200,
                        name_cell='cell 1')
...
img = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/light/20-30min/cell2/cell2.tif')
maskDraw = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/light/20-30min/cell2/mask.tif')
plt.figure()
plt.imshow(img[0]*maskDraw,cmap='gray_r')
img_o = img*maskDraw
create_all(pathsave= "/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/code/output/light/latB_20-30min/cell2/",
                        img_o=img_o,
                        maskDraw=maskDraw,
                        size=6,eps=100,thresh_top=0.01,sigma=sigma,small=small,angleA=140,overlap=4,max_cost=200,
                        name_cell='cell 2')
...
img = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/light/20-30min/cell3/cell3.tif')
maskDraw = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/light/20-30min/cell3/mask.tif')
plt.figure()
plt.imshow(img[0]*maskDraw,cmap='gray_r')
img_o = img*maskDraw
create_all(pathsave= "/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/code/output/light/latB_20-30min/cell3/",
                        img_o=img_o,
                        maskDraw=maskDraw,
                        size=6,eps=100,thresh_top=0.01,sigma=sigma,small=small,angleA=140,overlap=4,max_cost=200,
                        name_cell='cell 3')

img = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/light/20-30min/cell4/cell4.tif')
maskDraw = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/light/20-30min/cell4/mask.tif')
plt.figure()
plt.imshow(img[0]*maskDraw,cmap='gray_r')
img_o = img*maskDraw
create_all(pathsave= "/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/code/output/light/latB_20-30min/cell4/",
                        img_o=img_o,
                        maskDraw=maskDraw,
                        size=6,eps=100,thresh_top=0.01,sigma=sigma,small=small,angleA=140,overlap=4,max_cost=200,
                        name_cell='cell 4')
...
img = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/light/control/cell1/cell1.tif')
maskDraw = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/light/control/cell1/mask.tif')
plt.figure()
plt.imshow(img[0]*maskDraw,cmap='gray_r')
img_o = img*maskDraw
create_all(pathsave= "/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/code/output/light/control/cell1/",
                        img_o=img_o,
                        maskDraw=maskDraw,
                        size=8,eps=100,thresh_top=0.01,sigma=2,small=small,angleA=140,overlap=4,max_cost=200,
                        name_cell='cell 1')


img = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/light/control/cell2/cell2.tif')
maskDraw = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/light/control/cell2/mask.tif')
plt.figure()
plt.imshow(img[0]*maskDraw,cmap='gray_r')
img_o = img*maskDraw
create_all(pathsave= "/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/code/output/light/control/cell2/",
                        img_o=img_o,
                        maskDraw=maskDraw,
                        size=6,eps=100,thresh_top=0.2,sigma=2,small=small,angleA=140,overlap=4,max_cost=200,
                        name_cell='cell 2')


img = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/light/control/cell3/cell3.tif')
maskDraw = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/light/control/cell3/mask.tif')
plt.figure()
plt.imshow(img[0]*maskDraw,cmap='gray_r')
img_o = img*maskDraw
create_all(pathsave= "/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/code/output/light/control/cell3/",
                        img_o=img_o,
                        maskDraw=maskDraw,
                        size=6,eps=100,thresh_top=0.01,sigma=2,small=small,angleA=140,overlap=4,max_cost=200,
                        name_cell='cell 3')

img = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/light/control/cell4/cell4.tif')
maskDraw = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/light/control/cell4/mask.tif')
plt.figure()
plt.imshow(img[0]*maskDraw,cmap='gray_r')
img_o = img*maskDraw
create_all(pathsave= "/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/code/output/light/control/cell4/",
                        img_o=img_o,
                        maskDraw=maskDraw,
                        size=6,eps=100,thresh_top=0.1,sigma=2,small=small,angleA=140,overlap=4,max_cost=200,
                        name_cell='cell 4')