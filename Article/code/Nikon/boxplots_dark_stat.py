...
# -*- coding: utf-8 -*-
"""
Created on Wed Sep 13 13:48:28 2023
...
# -*- coding: utf-8 -*-
"""
Created on Wed Sep 13 10:06:02 2023
...
df_all.to_csv('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/code/output/dark/'+'df_all.csv')
#####################
...
ylim=[[-.1,125*0.07/2],[-0.05,1.5],[0,310/0.065]]
...
df_allFullm.to_csv('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/code/output/dark/'+'df_allFullm.csv')
###############################################################################
#
# plots in 4 groups
#
...
pairs2  = [
    [('<3.3', 'Control'), ('3.3-6.5', 'Control')],
     [('<3.3', 'Control'), ('6.5-19.5', 'Control')],
     [('<3.3', 'Control'), ('>19.5', 'Control')],
     [('3.3-6.5', 'Control'), ('6.5-19.5', 'Control')],
     [('3.3-6.5', 'Control'), ('>19.5', 'Control')],
     [('6.5-19.5', 'Control'), ('>19.5', 'Control')],
     
     [('<3.3', '0-10 mins  ('3.3-6.5', '0-10 mins')],
      [('<3.3', '0-10 mins'), ('6.5-19.5', '0-10 mins')],
      [('<3.3', '0-10 mins'), ('>19.5', '0-10 mins')],
      [('3.3-6.5', '0-10 mins'), ('6.5-19.5', '0-10 mins')],
      [('3.3-6.5', '0-10 mins'), ('>19.5', '0-10 mins')],
      [('6.5-19.5', '0-10 mins'), ('>19.5', '0-10 mins')],
      
      [('<3.3', '10-20 mins'), ('3.3-6.5', '10-20 mins')],
       [('<3.3', '10-20 mins'), ('6.5-19.5', '10-20 mins')],
       [('<3.3', '10-20 mins'), ('>19.5', '10-20 mins')],
       [('3.3-6.5', '10-20 mins'), ('6.5-19.5', '10-20 mins')],
       [('3.3-6.5', '10-20 mins'), ('>19.5', '10-20 mins')],
       [('6.5-19.5', '10-20 mins'), ('>19.5', '10-20 mins')],
       
       [('<3.3', '20-30 mins'), ('3.3-6.5', '20-30 mins')],
        [('<3.3', '20-30 mins'), ('6.5-19.5', '20-30 mins')],
        #[('<3.3', '20-30 mins'), ('>19.5', '20-30 mins')],
        [('3.3-6.5', '20-30 mins'), ('6.5-19.5', '20-30 mins')],
        #[('3.3-6.5', '20-30 mins'), ('>19.5', '20-30 mins')],
        #[('6.5-19.5', '20-30 mins'), ('>19.5', '20-30 mins')],
     ]
