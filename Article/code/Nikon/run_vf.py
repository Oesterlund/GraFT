...
# -*- coding: utf-8 -*-
"""
Created on Thu Sep  7 14:19:38 2023
...
img = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/DMSO/cell1/cell1.tif')
maskDraw = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/DMSO/cell1/mask.tif')
plt.figure()
plt.imshow(img[0]*maskDraw,cmap='gray_r')
img_o = img*maskDraw
create_all(pathsave= "/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/code/output/DMSO/cell1/",
                        img_o=img_o,
                        maskDraw=maskDraw,
...
img = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/DMSO/cell2/cell2.tif')
maskDraw = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/DMSO/cell2/mask.tif')
plt.figure()
plt.imshow(img[0]*maskDraw,cmap='gray_r')
img_o = img*maskDraw
create_all(pathsave= "/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/code/output/DMSO/cell2/",
                        img_o=img_o,
                        maskDraw=maskDraw,
...
img = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/DMSO/cell3/cell3.tif')
maskDraw = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/DMSO/cell3/mask.tif')
plt.figure()
plt.imshow(img[0]*maskDraw,cmap='gray_r')
img_o = img*maskDraw
create_all(pathsave= "/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/code/output/DMSO/cell3/",
                        img_o=img_o,
                        maskDraw=maskDraw,
                        size=6,eps=100,thresh_top=0.1,sigma=sigma,small=small,angleA=140,overlap=4,max_cost=200,
                        name_cell='cell 3')

img = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/DMSO/cell4/cell4.tif')
maskDraw = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/DMSO/cell4/mask.tif')
plt.figure()
plt.imshow(img[0]*maskDraw,cmap='gray_r')
img_o = img*maskDraw
create_all(pathsave= "/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/code/output/DMSO/cell4/",
                        img_o=img_o,
                        maskDraw=maskDraw,
                        size=6,eps=100,thresh_top=0.1,sigma=sigma,small=small,angleA=140,overlap=4,max_cost=200,
                        name_cell='cell 4')
...
img = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/DSF/cell2/25uM DSF_2.tif')
maskDraw = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/DSF/cell2/mask.tif')
plt.figure()
plt.imshow(img[0]*maskDraw,cmap='gray_r')
img_o = img*maskDraw
create_all(pathsave= "/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/code/output/DSF/cell2/",
                        img_o=img_o,
                        maskDraw=maskDraw,
                        size=8,eps=100,thresh_top=.4,sigma=sigma,small=small,angleA=140,overlap=4,max_cost=200,
                        name_cell='cell 2')


img = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/DSF/cell3/cell3.tif')
maskDraw = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/DSF/cell3/mask.tif')
plt.figure()
plt.imshow(img[0]*maskDraw,cmap='gray_r')
img_o = img*maskDraw
create_all(pathsave= "/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/code/output/DSF/cell3/",
                        img_o=img_o,
                        maskDraw=maskDraw,
                        size=6,eps=100,thresh_top=0.1,sigma=sigma,small=small,angleA=140,overlap=4,max_cost=200,
                        name_cell='cell 3')
...
img = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/DSF/cell4/cell4.tif')
maskDraw = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/DSF/cell4/mask.tif')
maskDraw = np.asarray(maskDraw,dtype=bool)
plt.figure()
plt.imshow(img[0]*maskDraw,cmap='gray_r')
img_o = img*maskDraw
create_all(pathsave= "/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/code/output/DSF/cell4/",
                        img_o=img_o,
                        maskDraw=maskDraw,
                        size=6,eps=100,thresh_top=0.1,sigma=sigma,small=small,angleA=140,overlap=4,max_cost=200,
                        name_cell='cell 4')

img = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/DSF/cell5/cell5.tif')
maskDraw = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/DSF/cell5/mask.tif')
plt.figure()
plt.imshow(img[0]*maskDraw,cmap='gray_r')
img_o = img*maskDraw
create_all(pathsave= "/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/code/output/DSF/cell5/",
                        img_o=img_o,
                        maskDraw=maskDraw,
                        size=6,eps=100,thresh_top=0.1,sigma=sigma,small=small,angleA=140,overlap=4,max_cost=200,
                        name_cell='cell 5')
...
img = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/flg22/cell1/cell1.tif')
maskDraw = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/flg22/cell1/mask.tif')
plt.figure()
plt.imshow(img[0]*maskDraw,cmap='gray_r')
img_o = img*maskDraw
create_all(pathsave= "/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/code/output/flg22/cell1/",
                        img_o=img_o,
                        maskDraw=maskDraw,
                        size=6,eps=100,thresh_top=0.1,sigma=sigma,small=small,angleA=140,overlap=4,max_cost=200,
                        name_cell='cell 1')
...
img = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/flg22/cell2/cell2.tif')
maskDraw = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/flg22/cell2/mask.tif')
plt.figure()
plt.imshow(img[0]*maskDraw,cmap='gray_r')
img_o = img*maskDraw
create_all(pathsave= "/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/code/output/flg22/cell2/",
                        img_o=img_o,
                        maskDraw=maskDraw,
                        size=6,eps=100,thresh_top=0.1,sigma=sigma,small=small,angleA=140,overlap=4,max_cost=200,
                        name_cell='cell 2')
...
img = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/flg22/cell3/cell3.tif')
maskDraw = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/flg22/cell3/mask.tif')
plt.figure()
plt.imshow(img[0]*maskDraw,cmap='gray_r')
img_o = img*maskDraw
create_all(pathsave= "/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/code/output/flg22/cell3/",
                        img_o=img_o,
                        maskDraw=maskDraw,
                        size=6,eps=100,thresh_top=0.1,sigma=sigma,small=small,angleA=140,overlap=4,max_cost=200,
                        name_cell='cell 3')
...
img = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/flg22/cell5/cell5.tif')
maskDraw = io.imread('/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/flg22/cell5/mask.tif')
plt.figure()
plt.imshow(img[0]*maskDraw,cmap='gray_r')
img_o = img*maskDraw
create_all(pathsave= "/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/code/output/flg22/cell5/",
                        img_o=img_o,
                        maskDraw=maskDraw,
                        size=6,eps=100,thresh_top=0.1,sigma=sigma,small=small,angleA=140,overlap=4,max_cost=200,
                        name_cell='cell 5')
