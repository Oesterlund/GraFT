...
# -*- coding: utf-8 -*-
"""
Created on Wed Aug  9 11:26:54 2023
...
def df_time(pd_fil_info,pathsave,cell):
    ...
    data = {'filament length' : fil_len,'mean length per filament': mean_len,'median length per filament': med_len,
            ...
            'smooth5 filament intensity':avg_fil_int,'smooth5 filament intensity per length':avg_fil_intPL,'filament' : fil_tag, 'name':cell_no}
...
pathsave_day = '/home/isabella/Documents/PLEN/dfs/data/Zhiming/31-07-23/code/output/light/timeseries/'
#control
