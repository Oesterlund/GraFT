...
# load in test data
graphSave = overpath+'/noise001/noise20/graph/'

path_imgs = overpath+'/noise001/noise20/'
...
dataUtils.use_GraFT(imgs_list=imgs_list,path_imgs=path_imgs,box_size=500,graphSave= graphSave
                    ,size=6,eps=100,thresh_top=0.3,sigma=1,small=20)
...
savepathLines = overpath+'/noise001/noise20/line_comparisons/'

files_csv = overpath+'/noise001/noise20/'
...
graph_path = overpath+'/noise001/noise20/graph/'
