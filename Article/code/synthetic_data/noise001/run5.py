...
# load in test data
graphSave = overpath+'/noise001/noise5/graph/'

path_imgs = overpath+'/noise001/noise5/'
...
listCt = np.array([453, 476, 347, 234, 184, 125,  26, 441, 154])
...
savepathLines = overpath+'/noise001/noise5/line_comparisons/'

files_csv = overpath+'/noise001/noise5/'
...
graph_path = overpath+'/noise001/noise5/graph/'
